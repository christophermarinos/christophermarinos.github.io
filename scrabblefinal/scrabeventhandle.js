...
window.onload = function() {
    ...
    BOARD = new Array(15);//make a double barrrel array
    ...
    for(i = 0; i < BOARD.length; i++){
        for(j = 0; j < BOARD.length; j++){
            ...
            p.wholeword = false;//Is my multiplier applie to the whole word?
...
//so I cut and pasted flipping along the y axis (and yes I could have saved time and done the same along x, filling in the center x and y axes by hand
    BOARD[0][14].score =3;
